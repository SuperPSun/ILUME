...
- [ADR-0016：Stage 2 统一 ObjectEncoder 与全覆盖训练（执行合同部分已取代）](0016-stage2-universal-object-modeling.md)
- [ADR-0017：Stage 1 Base 的 global batch 与 eager 执行](0017-stage1-base-runtime-profile.md)
- [ADR-0018：Stage 2 Object v2 Prepare/Train 高吞吐合同](0018-stage2-object-v2-throughput.md)
