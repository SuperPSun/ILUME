...
- [ADR-0011：Stage 3 单阶段双域完全隔离（已取代）](0011-stage3-single-stage-isolated-domains.md)
- [ADR-0012：Stage 3 高吞吐与预算守恒执行合同（已取代）](0012-stage3-throughput-and-budget.md)
...
- [ADR-0016：Stage 2 统一 ObjectEncoder 与全覆盖训练（已由 ADR-0019 进一步取代）](0016-stage2-universal-object-modeling.md)
