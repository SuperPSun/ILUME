...
- Stage 3：[ADR-0020](0020-stage3-v1-sparse-home-pcgrad.md) 定义 sparse-label HoME 与 hierarchical PCGrad；现役 v2 与对应消融的 ownership-aware clipping 和严格 raw sampling 由 [ADR-0046](0046-stage3-ownership-clipping-raw-sampling.md) 定义，deterministic 四阶段训练、per-group/task capacity 与 final-state stitching 由 [ADR-0047](0047-stage3-deterministic-four-phase-training.md) 定义。ADR-0027 的 Stage 3 refinement 仅继续约束 legacy v1/Capacity，ADR-0041 的 v2 Base 三阶段搜索已经退役。
