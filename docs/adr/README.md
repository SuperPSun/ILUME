...
- Stage 3：[ADR-0020](0020-stage3-v1-sparse-home-pcgrad.md) 定义 sparse-label HoME 与 hierarchical PCGrad；末期 PRIVATE-only refinement 由 [ADR-0027](0027-late-taskwise-refinement.md) 定义，主线宽度由 ADR-0039 修订。ADR-0041 的 v2 Base 三阶段搜索已经退役。
