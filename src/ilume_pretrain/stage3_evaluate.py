...
from .stage3_config import DOMAIN_TASKS, Stage3Config
from .stage3_data import Stage3TaskDataset
from .stage3_model import Stage3MultiDomainModel
from .stage3_prepare import load_frozen_embeddings
from .stage3_training import (
...
def _validate_domain_contract(
    ...
    expected = {
        ...
        "stage2_checkpoint_hash": metadata["provenance"][
    ...
    if combined:
        ...
        contracts = {
            domain: {
                ...
                "stage2_checkpoint_hash": checkpoint[
                    "stage2_checkpoint_hash"
                ],
