...
class Stage2InitializationConfig:
    checkpoint: Path = Path(
        "artifacts/training/pretrain_base_bs512/checkpoint_epoch_00005.pt"
    )
...
class Stage2Config:
    ...
    def validate(self) -> None:
        ...
        positive = {
            ...
            "training.keep_last_checkpoints": training.keep_last_checkpoints,
        }
...
def _construct(section_type: type, values: dict[str, Any] | None) -> Any:
    ...
    elif section_type is Stage2TrainingConfig:
