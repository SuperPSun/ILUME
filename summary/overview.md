...
1. ILUME — macro normalized MAE 0.192815
...
2. ILUME — macro normalized MAE 0.214304
...
3. ILUME — macro normalized MAE 0.142536

## Partial Charge

1. ILUME — macro normalized MAE 0.145597
Not evaluated: ecfp_xgboost@outputs/benchmarks/v1/ecfp_xgboost, mlp@outputs/benchmarks/v1/mlp
Not eligible: None

## Stage 2 FULL

1. ILUME — macro normalized MAE 0.143302
Not evaluated: ecfp_xgboost@outputs/benchmarks/v1/ecfp_xgboost, mlp@outputs/benchmarks/v1/mlp
Not eligible: None
